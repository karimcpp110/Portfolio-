...
export const EXPERIENCE: Experience[] = [
  {
    ...
    description: [
      ...
      "Served as Participation Manager, TA Lead, Mentor, and Instructor for the SmartGen Championship 2026, teaching robotics, AI, and technical concepts to participating students.",
      "Coordinated participant engagement, logistics, communication, and overall workflow throughout the competition lifecycle.",
      "Guided teams through technical challenges and helped transform ideas into real working projects.",
      "Followed up closely with participating teams to ensure continuous progress, collaboration, and effective project execution.",
      "Represented the Computer Science faculty during school tours alongside Zeiad Abo Gebba, introducing students to robotics, AI, programming, and the SmartGen experience.",
      "Helped create a supportive and motivating environment where students could confidently learn, innovate, collaborate, and compete.",
      "Contributed to building an organized workflow between technical, logistics, mentoring, and media teams to ensure smooth event execution.",
    ],
    skills: [
      SkillNames.REACT,
      SkillNames.NODEJS,
