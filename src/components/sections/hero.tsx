...
const HeroSection = () => {
  ...
  return (
    <SectionWrapper id="hero" className={cn("relative w-full min-h-screen py-20 md:py-0")}>
                ...
                <BlurIn delay={1}>
                  <Tooltip delayDuration={300}>
                    <TooltipTrigger asChild>
                      <h1
                        className={cn(
                          "-ml-[6px] leading-none font-bold text-transparent text-left",
                          "text-7xl md:text-7xl lg:text-8xl xl:text-9xl",
                          "cursor-default font-display transition-all duration-500",
                          "bg-clip-text bg-gradient-to-br from-white via-zinc-400 to-zinc-600 dark:from-white dark:via-zinc-200 dark:to-zinc-500",
